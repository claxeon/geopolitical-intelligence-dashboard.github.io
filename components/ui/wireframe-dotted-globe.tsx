...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
    ...
    return (
      <div className={`dark flex items-center justify-center bg-neutral-900 rounded-2xl p-8 ${className}`}>
        <div className="text-center">
          ...
          <p className="dark text-neutral-400 text-sm">{error}</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      />
      <div className="absolute bottom-4 left-4 text-xs text-neutral-400 px-2 py-1 rounded-md dark bg-neutral-900">
